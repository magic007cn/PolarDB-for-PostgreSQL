import{_ as r,r as l,o as c,c as d,a as s,b as n,d as a,w as o,e as t}from"./app-BZwogGMX.js";const m={},v=s("h1",{id:"定制开发环境",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#定制开发环境"},[s("span",null,"定制开发环境")])],-1),u=s("h2",{id:"自行构建开发镜像",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#自行构建开发镜像"},[s("span",null,"自行构建开发镜像")])],-1),b={href:"https://hub.docker.com/r/polardb/polardb_pg_devel/tags",target:"_blank",rel:"noopener noreferrer"},k=s("code",null,"polardb/polardb_pg_devel",-1),g=s("code",null,"linux/amd64",-1),h=s("code",null,"linux/arm64",-1),_={href:"https://hub.docker.com/_/ubuntu/tags",target:"_blank",rel:"noopener noreferrer"},f=s("code",null,"ubuntu:20.04",-1),S=t(`<details class="custom-container details"><div class="language-docker line-numbers-mode" data-ext="docker" data-title="docker"><pre class="language-docker"><code><span class="token instruction"><span class="token keyword">FROM</span> ubuntu:20.04</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><p>将上述内容复制到一个文件内（假设文件名为 <code>Dockerfile-PolarDB</code>）后，使用如下命令构建镜像：</p><div class="custom-container tip"><p class="custom-container-title">TIP</p><p>💡 请在下面的高亮行中按需替换 <code>&lt;image_name&gt;</code> 内的 Docker 镜像名称</p></div><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker</span> build <span class="token parameter variable">--network</span><span class="token operator">=</span>host <span class="token punctuation">\\</span>
...
</code></pre><div class="highlight-lines"><br><div class="highlight-line"> </div><br></div></div><h2 id="从干净的系统开始搭建开发环境" tabindex="-1"><a class="header-anchor" href="#从干净的系统开始搭建开发环境"><span>从干净的系统开始搭建开发环境</span></a></h2><p>该方式假设您从一台具有 root 权限的干净的 CentOS 7 操作系统上从零开始，可以是：</p><ul><li>安装 CentOS 7 的物理机/虚拟机</li><li>从 CentOS 7 官方 Docker 镜像 <code>centos:centos7</code> 上启动的 Docker 容器</li></ul><h3 id="建立非-root-用户" tabindex="-1"><a class="header-anchor" href="#建立非-root-用户"><span>建立非 root 用户</span></a></h3><p>PolarDB for PostgreSQL 需要以非 root 用户运行。以下步骤能够帮助您创建一个名为 <code>postgres</code> 的用户组和一个名为 <code>postgres</code> 的用户。</p><div class="custom-container tip"><p class="custom-container-title">TIP</p><p>如果您已经有了一个非 root 用户，但名称不是 <code>postgres:postgres</code>，可以忽略该步骤；但请注意在后续示例步骤中将命令中用户相关的信息替换为您自己的用户组名与用户名。</p></div><p>下面的命令能够创建用户组 <code>postgres</code> 和用户 <code>postgres</code>，并为该用户赋予 sudo 和工作目录的权限。需要以 root 用户执行这些命令。</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># install sudo</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>接下来，切换到 <code>postgres</code> 用户，就可以进行后续的步骤了：</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">su</span> postgres
<span class="token builtin class-name">source</span> /etc/bashrc
<span class="token builtin class-name">cd</span> ~
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="依赖安装" tabindex="-1"><a class="header-anchor" href="#依赖安装"><span>依赖安装</span></a></h3><p>在 PolarDB for PostgreSQL 源码库根目录的 <code>deps/</code> 子目录下，放置了在各个 Linux 发行版上编译安装 PolarDB 和 PFS 需要运行的所有依赖。因此，首先需要克隆 PolarDB 的源码库。</p>`,16),E={href:"https://github.com/ApsaraDB/PolarDB-for-PostgreSQL",target:"_blank",rel:"noopener noreferrer"},N=s("code",null,"POLARDB_11_STABLE",-1),P={href:"https://gitee.com/mirrors/PolarDB-for-PostgreSQL",target:"_blank",rel:"noopener noreferrer"},R=s("div",{class:"language-bash","data-ext":"sh","data-title":"sh"},[s("pre",{class:"language-bash"},[s("code",null,[s("span",{class:"token function"},"sudo"),n(" yum "),s("span",{class:"token function"},"install"),n(),s("span",{class:"token parameter variable"},"-y"),n(),s("span",{class:"token function"},"git"),n(`
...
`)])])],-1),y=s("div",{class:"language-bash","data-ext":"sh","data-title":"sh"},[s("pre",{class:"language-bash"},[s("code",null,[s("span",{class:"token function"},"sudo"),n(" yum "),s("span",{class:"token function"},"install"),n(),s("span",{class:"token parameter variable"},"-y"),n(),s("span",{class:"token function"},"git"),n(`
...
`)])])],-1),D=t(`<p>源码下载完毕后，使用 <code>sudo</code> 执行 <code>deps/</code> 目录下的相应脚本 <code>deps-***.sh</code> 自动完成所有的依赖安装。比如：</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token builtin class-name">cd</span> PolarDB-for-PostgreSQL
<span class="token function">sudo</span> ./deps/deps-centos7.sh
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,2);function O(w,L){const e=l("ExternalLinkIcon"),i=l("CodeGroupItem"),p=l("CodeGroup");return c(),d("div",null,[v,u,s("p",null,[n("DockerHub 上已有构建完毕的开发镜像 "),s("a",b,[k,a(e)]),n(" 可供直接使用（支持 "),g,n(" 和 "),h,n(" 两种架构）。")]),s("p",null,[n("另外，我们也提供了构建上述开发镜像的 Dockerfile，从 "),s("a",_,[n("Ubuntu 官方镜像"),a(e)]),n(),f,n(" 开始构建出一个安装完所有开发和运行时依赖的镜像，您可以根据自己的需要在 Dockerfile 中添加更多依赖。以下是手动构建镜像的 Dockerfile 及方法：")]),S,s("p",null,[n("PolarDB for PostgreSQL 的代码托管于 "),s("a",E,[n("GitHub"),a(e)]),n(" 上，稳定分支为 "),N,n("。如果因网络原因不能稳定访问 GitHub，则可以访问 "),s("a",P,[n("Gitee 国内镜像"),a(e)]),n("。")]),a(p,null,{default:o(()=>[a(i,{title:"GitHub"},{default:o(()=>[R]),_:1}),a(i,{title:"Gitee 国内镜像"},{default:o(()=>[y]),_:1})]),_:1}),D])}const B=r(m,[["render",O],["__file","customize-dev-env.html.vue"]]),U=JSON.parse('{"path":"/development/customize-dev-env.html","title":"定制开发环境","lang":"en-US","frontmatter":{},"headers":[{"level":2,"title":"自行构建开发镜像","slug":"自行构建开发镜像","link":"#自行构建开发镜像","children":[]},{"level":2,"title":"从干净的系统开始搭建开发环境","slug":"从干净的系统开始搭建开发环境","link":"#从干净的系统开始搭建开发环境","children":[{"level":3,"title":"建立非 root 用户","slug":"建立非-root-用户","link":"#建立非-root-用户","children":[]},{"level":3,"title":"依赖安装","slug":"依赖安装","link":"#依赖安装","children":[]}]}],"git":{"updatedTime":1710233880000},"filePathRelative":"development/customize-dev-env.md"}');export{B as comp,U as data};
